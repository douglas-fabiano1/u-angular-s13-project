...
export class UsersService {
  ...
  getUsers(): Observable<any> {
    ...
    /* return of(this.usersList); Retorna o valor ao fazer o subscribe, porém o 'return of' é sincrono (vai retornar o valor na hora),
     no entanto, nesse projeto, vamos fazer uma simulação assíncrona (simulando uma chamada http) */
  }
}
